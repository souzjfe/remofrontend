...
export default function NovaTarefa() {
    ...
    async function excluirTarefa(){
        try{
            await api.delete(`tarefadelete/${id}`,{
                headers:{
                ...
                <div className="container mx-auto bg-white dark:bg-gray-800 mt-10 rounded px-4">
                    <div className="xl:w-full border-b border-gray-300 dark:border-gray-700 py-5">
                        <div className="flex w-11/12 mx-auto xl:w-full xl:mx-0 items-center">
                            ...
                            <button onClick={() =>  excluirTarefa()}  className="bg-red-400 focus:outline-none transition duration-150 ease-in-out hover:bg-red-600 rounded text-white px-1 py-1 text-sm mx-4 " >
                                <HiTrash  size={21} color="white"/>
                            </button>
                        </div>
                    </div>
                    ...
                    <form id="login" onSubmit={handleNovaTarefa}>
                        <div className="mx-auto pt-4 ">
                            ...
                            <div className="container mx-auto  flex justify-center">
                                <div className="xl:w-4/6 lg:w-1/2 md:w-1/2 flex flex-col mb-6 mx-2">
